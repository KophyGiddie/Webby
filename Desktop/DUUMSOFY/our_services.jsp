...
<!--[if gt IE 9]><!-->	<html> <!--<![endif]-->
   <head>
      ...
      <meta name="author" content="Liman,Alfred & Liman">
      <!-- Mobile Metas -->
      ...
      <div class="wrap">
               ...
               <div class="slidedown collapse">
                  <div class="container">
                     <div class="phone-email pull-left">
                        ...
                        <a href="akyede@piemicrosystems.com"><i class="icon-envelope"></i> Email : akyede@piemicrosystems.com</a>
                     </div>
            ...
            <div class="main-header">
               <div class="container">
                  ...
                  <div class="logo pull-left">
                     <h1>
                        <a href="index.html">
                            <h1 style="font-size: 60px; ">AKYEDE</h1>
                        </a>
                     </h1>
                  </div>
                  <!-- Logo End -->
               ...
               <div class="container">
                  <div class="row">
                     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <h3 class="title">Three Reasons to Join Us</h3>
                     </div>
                     <div class="divider"></div>
                     <div class="reasons">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 animate_afc d2">
                           <div class="content-box big ch-item bottom-pad-small">
                              ...
                              <div class="content-box-info">
                                 <h3>Events Management & Notifications</h3>
                                 <p>
                                    Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.
                                 </p>
                                 <a href="#">Read More <i class="icon-angle-right"></i><i class="icon-angle-right"></i></a>
         ...
         <footer id="footer">
                     ...
                     <section class="col-lg-3 col-md-3 col-xs-12 col-sm-3 footer-three">
                        ...
                        <ul class="contact-us">
                           ...
                           <li>
                              ...
                              <p><strong>Phone:</strong> +233 262836997</p>
                           </li>
                           <li>
                              <i class="icon-envelope"></i>
                              <p><strong>Email:</strong><a href="mailto:akyede@piemicrosystems.com" style="font-size: 10px;">akyede@piemicrosystems.com</a></p>
                           </li>
                        </ul>
                     </section>
            ...
            <div class="footer-bottom">
               <div class="container">
                  <div class="row">
                     <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6 "> &copy; Copyright 2013 by <a href="#">Akyede</a>. All Rights Reserved. </div>
                     <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6 ">
